...
(async () => {
  ...
  await fs.writeFile("acute-cutaneous-lupus-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("acute-cutaneous-lupus-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
